...
function validatePatent()
{
	...
	else
	{
		...
		if(	patentToValidate.length == 6 &&
			!regularExpressionFormat_1.test(patentToValidate))
		{
			strBuilderValidateSearch.push('<li>' + 'El formato de la patente debe ser <b>ABC123</b>' + '</li>');
			mustShowMessage = true;
		}
		else if(patentToValidate.length == 7 &&
				!regularExpressionFormat_2.test(patentToValidate))
		{
			strBuilderValidateSearch.push('<li>' + 'El formato de la patente debe ser <b>AB123CD</b>' + '</li>');
			mustShowMessage = true;
		}
		else if(patentToValidate.length < 6 ||
				patentToValidate.length > 7)
		{
